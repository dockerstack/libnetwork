...
func TestDiff(t *testing.T) {
	existing := []net.IP{net.ParseIP("1.1.1.1"), net.ParseIP("2.2.2.2")}
	addedIP := net.ParseIP("3.3.3.3")
	updated := append(existing, addedIP)
...
func TestAddedCallback(t *testing.T) {
	hd := hostDiscovery{}
	hd.nodes = []net.IP{net.ParseIP("1.1.1.1")}
...
func TestRemovedCallback(t *testing.T) {
	hd := hostDiscovery{}
	hd.nodes = []net.IP{net.ParseIP("1.1.1.1"), net.ParseIP("2.2.2.2")}
